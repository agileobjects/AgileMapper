...
{
    /// <summary>
    /// Sets the given <paramref name="target"/> instance as the
    /// <see cref="IMappingExecutionContext"/>'s target.
    /// </summary>
    /// <param name="target">The target instance to set.</param>
    /// <returns>This <see cref="IMappingExecutionContext"/>, to support a fluent API.</returns>
    IMappingExecutionContext SetTarget(object target);
