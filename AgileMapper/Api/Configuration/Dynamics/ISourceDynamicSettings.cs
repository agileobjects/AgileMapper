namespace AgileObjects.AgileMapper.Api.Configuration.Dynamics
{
    ...
    {
        /// <summary>
        /// Construct keys for target Dynamic members using flattened member names. For example, a
        /// Person.Address.StreetName member would be mapped to a Dynamic member with the name
        /// 'AddressStreetName'.
        /// </summary>
        /// <returns>
        ...
        /// any target type. For example, calling UseMemberName("_") will require a source ExpandoObject 
        /// member with the name 'Address_Line1' to map to an Address.Line1 member. Any string can be 
        /// specified as a separator - even if it would create illegal member names like 'Address-Line1' -
        /// because ExpandoObjects are mapped as IDictionary{string, Object}s.
        /// </summary>
