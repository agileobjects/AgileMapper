namespace AgileObjects.AgileMapper.Api.Configuration.Dynamics
{
    ...
    /// </summary>
    public interface IGlobalDynamicSettings
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="IGlobalDynamicSettings"/> with which to configure other global aspects of 
        ...
        /// ExpandoObject mapping.
        /// </returns>
        IGlobalDynamicSettings UseMemberNameSeparator(string separator);

        /// <summary>
        /// Use the given <paramref name="pattern"/> to create the part of a sourec or target Dynamic member 
        /// name representing an enumerable element - the default is '_i_'. The pattern must contain a single 
        /// 'i' character as a placeholder for the enumerable index. Any pattern can be specified as an element 
        ...
        /// </param>
        /// <returns>
        /// The <see cref="IGlobalDynamicSettings"/> with which to configure other global aspects of ExpandoObject 
        /// mapping.
        /// </returns>
        IGlobalDynamicSettings UseElementKeyPattern(string pattern);
