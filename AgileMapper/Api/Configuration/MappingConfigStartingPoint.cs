    ...
    IProjectionConfigStartingPoint
{
    ...
    {
        _configInfo = new(mapperContext.ThrowIfDisposed());
    }
    ...
    /// </summary>
    public MapperConfigurationSpecifier UseConfigurations => new(_configInfo.MapperContext.Mapper);
    ...
    /// An <see cref="IGlobalMappingSettings"/>, with which to globally configure other mapping aspects.
    /// </returns>
    public IGlobalMappingSettings SwallowAllExceptions()
        => PassExceptionsTo(new ExceptionSwallower(GlobalConfigInfo));
    ...
    private IGlobalMappingSettings PassExceptionsTo(ExceptionCallback callback)
    {
    ...
    public InstanceConfigurator<TObject> InstancesOf<TObject>(TObject exampleInstance)
        where TObject : class
    {
        return InstancesOf<TObject>();
    }
    ...
    /// <typeparam name="TObject">The type of object to which the configuration will apply.</typeparam>
    /// <returns>An InstanceConfigurator with which to complete the configuration.</returns>
    public InstanceConfigurator<TObject> InstancesOf<TObject>()
        where TObject : class
    {
