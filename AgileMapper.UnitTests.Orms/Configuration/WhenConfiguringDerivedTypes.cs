namespace AgileObjects.AgileMapper.UnitTests.Orms.Configuration
{
        ...
        where TOrmContext : ITestDbContext, new()
    {
        ...
        private static async Task DoShouldProjectToConfiguredDerivedTypes(TOrmContext context)
        {
        ...
        private static async Task DoShouldProjectToAFallbackDerivedType(TOrmContext context)
        {
            var fido = new Animal { Type = Dog, Name = "Fido", Sound = "Bark" };
        ...
        private static async Task DoShouldNotAttemptToApplyDerivedSourceTypePairing(TOrmContext context)
        {
